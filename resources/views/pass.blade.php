...
<body>
    ...
    <main>
        <section class="relative-positioned section section--dark-background section--success">
            <div class="container hero__container relative-positioned">
                <div class="hero__info">
                    <h1 class="hero__title title--success">
                        Thank you for ordering a cleaning!
                    </h1>
                    <p class="hero__text">
                        I will contact you shortly to confirm the date and time of the cleaning.
                    </p>
